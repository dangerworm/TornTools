...
const useMarketplaceQuery = (itemId: number | undefined): Weav3rMarketplaceState => {
    ...
    try {
      ...
      if (result?.listings?.length) {
        postWeav3rListings(
          ...
          /* silent - don't affect UX if relay fails */
        })
      }
    } catch (e) {
...
export const useWeav3rMarketplaceQuery = (itemId: number | undefined) => useMarketplaceQuery(itemId)
