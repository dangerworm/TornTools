...
CREATE INDEX IF NOT EXISTS ix_listings_item_id_source
...
CREATE INDEX IF NOT EXISTS ix_item_change_logs_item_id_change_time
...
CREATE INDEX IF NOT EXISTS ix_item_change_logs_change_time
...
CREATE INDEX IF NOT EXISTS ix_users_key_available_api_key_last_used
...
CREATE INDEX IF NOT EXISTS ix_queue_items_item_status_next_attempt_at_queue_index
