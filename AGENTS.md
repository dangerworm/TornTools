...
This project is indexed by GitNexus as **TornTools** (1837 symbols, 5248 relationships, 126 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
